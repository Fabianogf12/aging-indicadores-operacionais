...
✔ Status do prazo (Dentro / Atenção / Urgente / Vence Hoje / Vencido)
✔ Layout profissional com cabeçalho e identidade visual da TIM

📸 Exemplo da Planilha (Screenshot)

(Você pode colocar a imagem depois: “Insert → Add file → Upload image”)
Mas por enquanto deixe assim.
...
Funções: SE(), DIFDATA, CONT.SE, REGRAS PERSONALIZADAS
